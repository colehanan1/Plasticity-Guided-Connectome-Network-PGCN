#!/usr/bin/env python3
"""
Generate Comprehensive Mechanistic Figure v12 for Publication (INCREASED PANEL SPACING)

This script creates the FINAL publication-ready 5-panel figure with increased
spacing between top panels to prevent title and axis label overlap.

Improvements over v11 (1 spacing refinement):
1. Increased horizontal spacing (wspace) from 0.40 to 0.55
   - Prevents title overlap between panels A, B, and C
   - Prevents axis label overlap
   - Better visual separation between top panels

Maintains v11 layout: Top row (A, B, C wider), Bottom row (D wide, E narrow)

Author: PGCN Project
Date: 2025-11-19

Usage:
    python src/scripts/experiments/generate_mechanism_figure_v12.py
"""
...
def generate_comprehensive_figure_v12(output_dir='figures'):
    """Generate the complete 5-panel mechanistic figure v12 with increased panel spacing."""
    print("\n" + "="*80)
    print("GENERATING COMPREHENSIVE MECHANISTIC FIGURE V12 (INCREASED SPACING)")
    print("="*80)
    print("\nSpacing refinement over v11:")
    print("  1. Increased wspace from 0.40 to 0.55 (37.5% more horizontal space)")
    print("  2. Prevents title overlap between panels A, B, and C")
    print("  3. Prevents axis label overlap")
    print("\nMaintains v11 layout:")
    print("  Top row: A (1 col), B (1 col), C (2 cols - WIDER)")
    print("  Bottom row: D (3 cols wide), E (1 col)")
    print("="*80 + "\n")

    # v12: Increased wspace for better panel separation
    fig = plt.figure(figsize=(16, 10))

    # Create grid layout: 2 rows x 4 columns
    # Top row: A (1 col), B (1 col), C (2 cols - WIDER)
    # Bottom row: D (spans 3 cols), E (1 col)
    gs = GridSpec(2, 4, figure=fig, hspace=0.35, wspace=0.55,  # v12: increased wspace!
    ...
    pdf_file = output_path / 'comprehensive_mechanism_figure_v12.pdf'
    png_file = output_path / 'comprehensive_mechanism_figure_v12.png'

    # v12: Same generous padding
    ...
    print("\n" + "="*80)
    print("✅ FIGURE V12 WITH INCREASED SPACING COMPLETE")
    print("="*80)
    print(f"Saved: {pdf_file}")
    print(f"Saved: {png_file}")
    print("\nSpacing refinements documented:")
    print("  ✅ Top row: A (1 col), B (1 col), C (2 cols)")
    print("  ✅ Bottom row: D (3 cols wide), E (1 col)")
    print("  ✅ wspace=0.55 (increased from 0.40) - prevents title/axis overlap")
    print("  ✅ 37.5% more horizontal space between panels")
    print("  ✅ Better visual separation and readability")
...
if __name__ == '__main__':
    print("\n" + "="*80)
    print("COMPREHENSIVE MECHANISTIC FIGURE V12 - PUBLICATION READY (INCREASED SPACING)")
    print("="*80 + "\n")

    fig = generate_comprehensive_figure_v12()

    print("\n" + "="*80)
    print("INCREASED PANEL SPACING LAYOUT VERIFICATION:")
    print("="*80)
    print("✅ Top row: A (1 col), B (1 col), C (2 cols)")
    print("✅ Bottom row: D (3 cols wide), E (1 col)")
    print("✅ GridSpec: 2x4 (same as v11)")
    print("✅ wspace=0.55 (INCREASED from 0.40) - prevents title and axis overlap")
    ...
    print("\n🎉 Figure v11 FINAL - READY FOR BIOarxiv/ELIFE SUBMISSION!")
    print("="*80 + "\n")
