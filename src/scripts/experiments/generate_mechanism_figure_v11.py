#!/usr/bin/env python3
"""
Generate Comprehensive Mechanistic Figure v11 for Publication (WIDER PANEL C)

This script creates the FINAL publication-ready 5-panel figure with Panel C
widened for better data visibility.

Improvements over v10 (1 layout refinement):
1. Panel C widened to span 2 columns (was 1 column)
   - Uses 4-column GridSpec instead of 3-column
   - Panel A: 1 col, Panel B: 1 col, Panel C: 2 cols (wider!)
   - Panel D adjusted to span 3 cols, Panel E: 1 col

New 5-panel layout: Top row (A, B, C wider), Bottom row (D wide, E narrow)

Author: PGCN Project
Date: 2025-11-19

Usage:
    python src/scripts/experiments/generate_mechanism_figure_v11.py
"""
...
def generate_comprehensive_figure_v11(output_dir='figures'):
    """Generate the complete 5-panel mechanistic figure v11 with wider Panel C."""
    print("\n" + "="*80)
    print("GENERATING COMPREHENSIVE MECHANISTIC FIGURE V11 (WIDER PANEL C)")
    print("="*80)
    print("\nLayout refinement over v10:")
    print("  1. Panel C widened to span 2 columns (was 1 column)")
    print("  2. GridSpec changed from 2x3 to 2x4 for finer control")
    print("  3. Panel D adjusted to span 3 columns (was 2 columns)")
    print("\nNew 5-panel layout:")
    print("  Top row: A (1 col), B (1 col), C (2 cols - WIDER)")
    print("  Bottom row: D (3 cols wide), E (1 col)")
    print("="*80 + "\n")

    # v11: 4-column GridSpec for wider Panel C
    fig = plt.figure(figsize=(16, 10))

    # Create grid layout: 2 rows x 4 columns
    # Top row: A (1 col), B (1 col), C (2 cols - WIDER)
    # Bottom row: D (spans 3 cols), E (1 col)
    gs = GridSpec(2, 4, figure=fig, hspace=0.35, wspace=0.40,
    ...
    pdf_file = output_path / 'comprehensive_mechanism_figure_v11.pdf'
    png_file = output_path / 'comprehensive_mechanism_figure_v11.png'

    # v11: Same generous padding
    ...
    print("\n" + "="*80)
    print("✅ FIGURE V11 WITH WIDER PANEL C COMPLETE")
    print("="*80)
    print(f"Saved: {pdf_file}")
    print(f"Saved: {png_file}")
    print("\nLayout refinements documented:")
    print("  ✅ Top row: A (1 col), B (1 col), C (2 cols - WIDER)")
    print("  ✅ Bottom row: D (3 cols wide), E (1 col)")
    print("  ✅ GridSpec: 2x4 (was 2x3)")
    print("  ✅ Panel C width doubled for better data visibility")
...
if __name__ == '__main__':
    print("\n" + "="*80)
    print("COMPREHENSIVE MECHANISTIC FIGURE V11 - PUBLICATION READY (WIDER PANEL C)")
    print("="*80 + "\n")

    fig = generate_comprehensive_figure_v11()

    print("\n" + "="*80)
    print("WIDER PANEL C LAYOUT VERIFICATION:")
    print("="*80)
    print("✅ Top row: A (1 col), B (1 col), C (2 cols - WIDER!)")
    print("✅ Bottom row: D (3 cols wide), E (1 col)")
    print("✅ GridSpec: 2x4 (was 2x3 in v10)")
    print("✅ wspace=0.40 prevents axis label overlap")
